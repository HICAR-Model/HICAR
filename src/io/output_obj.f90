...
contains
    ...
    module subroutine add_variables(this, var_list, domain)
        ...
        if (0<var_list( kVARS%ice1_a))                      call this%add_to_output( get_metadata( kVARS%ice1_a                       , domain%ice1_a%data_3d))
        if (0<var_list( kVARS%ice1_c))                      call this%add_to_output( get_metadata( kVARS%ice1_c                       , domain%ice1_c%data_3d))
        if (0<var_list( kVARS%ice2_mass))                   call this%add_to_output( get_metadata( kVARS%ice2_mass                    , domain%ice2_mass%data_3d))
        if (0<var_list( kVARS%ice2_number))                 call this%add_to_output( get_metadata( kVARS%ice2_number                  , domain%ice2_number%data_3d))
        if (0<var_list( kVARS%ice2_a))                      call this%add_to_output( get_metadata( kVARS%ice2_a                       , domain%ice2_a%data_3d))
        if (0<var_list( kVARS%ice2_c))                      call this%add_to_output( get_metadata( kVARS%ice2_c                       , domain%ice2_c%data_3d))
        if (0<var_list( kVARS%ice3_mass))                   call this%add_to_output( get_metadata( kVARS%ice3_mass                    , domain%ice3_mass%data_3d))
        if (0<var_list( kVARS%ice3_number))                 call this%add_to_output( get_metadata( kVARS%ice3_number                  , domain%ice3_number%data_3d))
        if (0<var_list( kVARS%ice3_a))                      call this%add_to_output( get_metadata( kVARS%ice3_a                       , domain%ice3_a%data_3d))
        if (0<var_list( kVARS%ice3_c))                      call this%add_to_output( get_metadata( kVARS%ice3_c                       , domain%ice3_c%data_3d))
