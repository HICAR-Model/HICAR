...
!!!TLE: commented out groundwater_init and related modules to get simple Noah-MP test case up and running in ICAR.
!!!     Uncomment these subroutines and integrate necessary modules from WRF (e.g. module_domain, module_dm, etc.) when the time comes.
!! ==================================================================================================
!! ----------------------------------------------------------------------
...
!!!!TLE: commenting out urban functionality in order to get simplified Noah-MP running in ICAR.
!!!!     Uncomment urban subroutines and incorporate modules from WRF when setting up to run urban model.
!!!!     A call to the urban subroutines will also need to be implemented in the ICAR lsm_driver
!!------------------------------------------------------------------------------------------
!
