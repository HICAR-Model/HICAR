...
!ctrlL
      ...
      SUBROUTINE thompson_aer_init(hgt, nwfa2d, nwfa, nifa, dx, dy,         &
                          is_start,                                     &
...
!..Conversion of some ice mass into snow category.
    ...
    !   CALL wrf_debug(150, ' ... DONE microphysical lookup tables')
      ...
      END SUBROUTINE thompson_aer_init
!+---+-----------------------------------------------------------------+
!ctrlL
!+---+-----------------------------------------------------------------+
!..This is a wrapper routine designed to transfer values from 3D to 1D.
!+---+-----------------------------------------------------------------+
      SUBROUTINE mp_gt_driver_aer(qv, qc, qr, qi, qs, qg, ni, nr, nc,       &
                              nwfa, nifa, nwfa2d,                       &
...
! END DEBUG - GT
      ...
      END SUBROUTINE mp_gt_driver_aer
...
!+---+-----------------------------------------------------------------+
END MODULE module_mp_thompson_aer
!+---+-----------------------------------------------------------------+
