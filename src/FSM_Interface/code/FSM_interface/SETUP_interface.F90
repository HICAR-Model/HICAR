...
if (Nsmax == 3) then
  ...
  print*, "Nsmax /= 3, Please specify your values for Dzsnow" 
  call exit()
endif
if (Nsoil == 4) then
...
if (TILE == 'forest') then
  ! asmx = 0.88
  hfsn = 0.25    ! use larger value to flatten depletion curve
  ! z0sn = 0.015   
endif 
