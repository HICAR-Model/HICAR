...
do tt = 1, Nt
  ...
  call RADIATION(alb,SWsrf,SWveg,Sdirt,Sdift,asrf_out,SWsci)
  ...
  call SNOW(Esrf,G,ksnow,ksoil,Melt,unload,Gsoil,Roff,meltflux_out,Sbsrf,dm_salt,dm_susp,dm_subl,dm_subgrid,dm_slide)
